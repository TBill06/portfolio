...
const Connect = () => {
    return(
        ...
        <ul className='text-[#CCD6F6] pt-4 text-4xl flex justify-center gap-10 sm:mx-auto'>
            <a href="https://github.com/TBill06"><FiGithub className='hover:text-[#58DFC3]' /></a>
            <a href="https://www.linkedin.com/in/tushar-billakanti-bb5969179/"><FiLinkedin className='hover:text-[#58DFC3]' /></a>
            <a href="https://twitter.com/Tushar_bill"><FiTwitter className='hover:text-[#58DFC3]'/></a>
        </ul>
